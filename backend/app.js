...
app.use(cors({ credentials: true, origin: ['https://localhost:3000', 'http://localhost3000', 'https://gabealena.students.nomoredomains.xyz', 'http://gabealena.students.nomoredomains.xyz'] }));
